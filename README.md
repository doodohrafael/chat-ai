...
## 🚀 Missão
O **Chat AI** é projetado para testar o estresse e explorar as capacidades do modelo **Google Gemini 1.5 Flash**. Construído com o ecossistema Java mais recente (JDK 25 e Spring Boot 4), este projeto serve como referência para integrar LLMs de baixa latência em aplicações servidoras atraves do **Spring AI**.
...
---
*Criado por um futuro Arquiteto para a próxima geração de Engenheiros de IA.*
